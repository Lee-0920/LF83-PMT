...
#define ADCx_CHANNELC_GPIO_CLK    RCC_AHB1Periph_GPIOC
#define ADCx_CHANNELD_GPIO_CLK    RCC_AHB1Periph_GPIOC

#define ADC_CHANNELA              ADC_Channel_10
#define ADC_CHANNELB              ADC_Channel_11
#define ADC_CHANNELC              ADC_Channel_12
#define ADC_CHANNELD              ADC_Channel_13

#define GPIO_CHANNELA_PIN         GPIO_Pin_0
#define GPIO_CHANNELA_PORT        GPIOC
#define GPIO_CHANNELB_PIN         GPIO_Pin_1
#define GPIO_CHANNELB_PORT        GPIOC
#define GPIO_CHANNELC_PIN         GPIO_Pin_2
#define GPIO_CHANNELC_PORT        GPIOC
#define GPIO_CHANNELD_PIN         GPIO_Pin_3
#define GPIO_CHANNELD_PORT        GPIOC
...
{
    RCC_AHB1PeriphClockCmd(ADCx_CHANNELA_GPIO_CLK | ADCx_CHANNELB_GPIO_CLK
            | ADCx_CHANNELC_GPIO_CLK | ADCx_CHANNELD_GPIO_CLK, ENABLE);
...
static void TempADCollect_GPIOConfiguration(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_CHANNELC_PIN;
    GPIO_Init(GPIO_CHANNELC_PORT, &GPIO_InitStructure);

    GPIO_InitStructure.GPIO_Pin = GPIO_CHANNELD_PIN;
    GPIO_Init(GPIO_CHANNELD_PORT, &GPIO_InitStructure);
}
...
static void TempADCollect_ADCConfiguration(void)
{
    ...
    ADC_RegularChannelConfig(ADCx, ADC_CHANNELC, 3, ADC_SampleTime_480Cycles);
    ADC_RegularChannelConfig(ADCx, ADC_CHANNELD, 4, ADC_SampleTime_480Cycles);
