...
/********串口配置********/
#define TMC_UART                                               UART4
#define TMC_UART_CLK                                       45                                //串口使用的时钟频率，APB1 为45M，APB2为90M
#define TMC_UART_BAUD                                   38400
#define TMC_UART_IRQn                                      UART4_IRQn
#define TMC_UART_IRQHANDLER                      UART4_IRQHandler
#define TMC_UART_RCC                                       RCC_APB1Periph_UART4

#define TMC_UART_GPIO_AF                               GPIO_AF_UART4
#define TMC_UART_TX_PIN                                   GPIO_Pin_10
#define TMC_UART_TX_PinSource                       GPIO_PinSource10
#define TMC_UART_TX_PORT                               GPIOC
#define TMC_UART_TX_RCC                                RCC_AHB1Periph_GPIOC

#define TMC_UART_RX_PIN                                  GPIO_Pin_11
#define TMC_UART_RX_PinSource                       GPIO_PinSource11
#define TMC_UART_RX_PORT                               GPIOC
#define TMC_UART_RX_RCC                                 RCC_AHB1Periph_GPIOC
...
void TMCConfigDriver_UARTInit(void)
{
    ...
    USART_Init(TMC_UART, &USART_InitStructure);
    {
        ...
        float temp = (float) (CLK_APB1) / (TMC_UART_BAUD * 16);
