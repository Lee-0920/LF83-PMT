...
void ThermostatDeviceManager_RestoreInit(void)
{
    ...
    if (FALSE == ThermostatDeviceManager_IsOpen(4))
    {
        ThermostatDeviceManager_SetOutput(4, 0);
    }

    if (FALSE == ThermostatDeviceManager_IsOpen(5))
    {
        ThermostatDeviceManager_SetOutput(5, 0);
    }
}
