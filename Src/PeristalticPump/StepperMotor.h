...
#define STEPPERMOTOR_MIN_SUBDIVISION_SPEED  160 //已细分的最小速度
#define STEPPERMOTOR_MAX_SUBDIVISION_SPEED  12000 //已细分的最大速度
/**
 * @brief 步进电机的忙碌状态
 */
typedef enum
...
typedef struct
{
    ...
    StepperMotor_FinishHandler finishHandler;
